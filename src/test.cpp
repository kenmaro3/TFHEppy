...
#include "include/service_dynamic.hpp"
...
PYBIND11_MODULE(tfheppy, m)
{
    ...
    py::class_<ServiceDynamic>(m, "ServiceDynamic")
        .def(py::init<int>())
        .def("gen_keys", &ServiceDynamic::gen_keys)
        .def("get_sk", &ServiceDynamic::get_sk)
        .def("get_gk", &ServiceDynamic::get_gk)
        .def("encrypt", &ServiceDynamic::encrypt, py::arg("x"))
        .def("encrypt_level1", &ServiceDynamic::encrypt_level1, py::arg("x"))
        // .def("encrypt_ring", &ServiceDynamic::encrypt_ring, py::arg("x"))
        .def("encrypt_ring_level1", &ServiceDynamic::encrypt_ring_level1, py::arg("x"))
        .def("encrypt_rgsw", &ServiceDynamic::encrypt_rgsw, py::arg("x"))

        .def("decrypt_level1", &ServiceDynamic::decrypt_level1, py::arg("x"))
        .def("decrypt", &ServiceDynamic::decrypt, py::arg("x"))
        // .def("decrypt_ring", &ServiceDynamic::decrypt_ring, py::arg("x"))
        .def("decrypt_ring_level1", &ServiceDynamic::decrypt_ring_level1, py::arg("x"))
        .def("serialize_sk", &ServiceDynamic::serialize_sk)
        .def("serialize_sk_to_file", &ServiceDynamic::serialize_sk_to_file, py::arg("path"))
        .def("deserialize_sk", &ServiceDynamic::deserialize_sk, py::arg("x"))
        .def("deserialize_sk_from_file", &ServiceDynamic::deserialize_sk_from_file, py::arg("path"))
        .def("serialize_gk", &ServiceDynamic::serialize_gk)
        .def("serialize_gk_to_file", &ServiceDynamic::serialize_gk_to_file, py::arg("path"))
        .def("deserialize_gk", &ServiceDynamic::deserialize_gk, py::arg("x"))
        .def("deserialize_gk_from_file", &ServiceDynamic::deserialize_gk_from_file, py::arg("path"))
        .def("set_sk_byte", py::overload_cast<py::bytes>(&ServiceDynamic::set_sk), py::arg("x"))
        .def("set_sk", py::overload_cast<Sk>(&ServiceDynamic::set_sk), py::arg("x"))
        .def("set_gk_byte", py::overload_cast<py::bytes>(&ServiceDynamic::set_gk), py::arg("x"))
        .def("set_gk", py::overload_cast<Gk>(&ServiceDynamic::set_gk), py::arg("x"));
}
